...
public class HiveJdbcClientExample {
	...
	public static void main(String[] args) throws SQLException {
		...
		Connection con = DriverManager.getConnection("jdbc:hive://172.31.35.141:10000/default", "somay3333228", "FRNHT5IA");
		//Statement stmt = con.createStatement();

		String tableName = "empdata111";
		//stmt.executeQuery("Show Databases; " + tableName);
